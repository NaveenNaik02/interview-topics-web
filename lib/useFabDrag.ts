...
// outside <UIProvider> in app/layout.tsx.
...
export function useFabDrag() {
  ...
  const dragRef = useRef<{ startX: number; startY: number; origin: Offset; moved: boolean } | null>(null)
  ...
  const onPointerDown = useCallback((e: React.PointerEvent<HTMLButtonElement>) => {
    ...
    dragRef.current = { startX: e.clientX, startY: e.clientY, origin: offset, moved: false }
