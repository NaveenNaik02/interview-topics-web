...
// Must match DEFAULT_SETTINGS.theme in lib/db/settings.ts
...
export async function resolveServerTheme(supabase: SupabaseServerClient, userId: string | undefined): Promise<Theme | undefined> {
