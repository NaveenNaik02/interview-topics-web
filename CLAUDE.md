...
See `components/CLAUDE.md` for UI primitives and component conventions (feature-first organization, when to split a file, root-level `components/` independence rules).
